...
app = Flask(__name__)
model = pickle.load(open('pycharm/saved_model_college.pkl', 'rb'))
model2 = pickle.load(open('pycharm/saved_model_admissoins.pkl', 'rb'))
model3 = pickle.load(open('pycharm/saved_model.pkl', 'rb'))
